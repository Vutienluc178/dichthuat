...
def create_app(enable_cors: bool = False, allow_origin_regex: str = r"^(https?://.*|null|file://.*)$") -> FastAPI:
    """
    Factory function to create FastAPI app instance.
    Useful for testing and serverless deployments.
    """
    _app = FastAPI(
        docs_url=None,
        redoc_url=None,
...
# Router is already included in create_app() function
...
def run_app(host=None, port: int | None = None, enable_CORS=False,
    ...
    try:
        ...
        if enable_CORS:
            ...
            # Recreate app with CORS enabled
            global app
            app = create_app(enable_cors=True, allow_origin_regex=allow_origin_regex)
